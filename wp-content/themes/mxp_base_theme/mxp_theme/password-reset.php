...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "password-reset.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="//robertcreativevibe.com/wp-content/themes/mxp_base_theme/mxp_theme/css/password-reset.css?crc=4007481722" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_password-reset.css?crc=3824530138"/>
  <link rel="stylesheet" type="text/css" href="css/nomq_preview_master_a-master-light.css?crc=4204244850"/>
  <link rel="stylesheet" type="text/css" href="css/nomq_password-reset.css?crc=4176119211" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">if( window.jQuery ){ var $ = jQuery.noConflict(); } 
  ...
  <!-- JS includes -->
  <script src="//webfonts.creativecloud.com/raleway:n4,n7:default.js" type="text/javascript">if( window.jQuery ){ var $ = jQuery.noConflict(); } </script>
    <!--custom head HTML-->
  ...
  <!--HTML Widget code-->
            ...
            #u40198 .um-field label, #u40198 .um-field-password_reset_text .um-field-block{
            ...
            #u40198 .um-field input, #u40198 .um-field textarea{
            ...
            #u40198 .um-field input::-webkit-input-placeholder { /* Chrome/Opera/Safari */
              color: #666666 !important;
            }
            #u40198 .um-field input::-moz-placeholder { /* Firefox 19+ */
              color: #666666 !important;
            }
            #u40198 .um-field input:-ms-input-placeholder { /* IE 10+ */
              color: #666666 !important;
            }
            #u40198 .um-field input:-moz-placeholder { /* Firefox 18- */
              color: #666666 !important;
            }

            #u40198 .um-col-alt input, #u40198 .um-col-alt a[href], #u40198 .um-col-alt-b a[href]{
                border-radius: 3px !important;
            ...
            #u40198 .um-col-alt input:hover, #u40198 .um-col-alt a[href]:hover, #u40198 .um-col-alt-b a[href]:hover{
                color: #FFFFFF !important;
            }

            #u40198 .um-field-checkbox span{
                color: #FFFFFF !important;
            }
            ...
            <?php echo do_shortcode('[mxp_um_include_google_fonts fonts="   "]'); ?>
  ...
  <div class="breakpoint active" id="bp_infinity" data-min-width="381"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox" id="page"><!-- group -->
    <div class="clearfix grpelem" id="pu55170"><!-- group -->
     <div id="u55170" class="shared_content" data-content-guid="u55170_content"><!-- simple frame --></div>
     ...
     <div class="Button menuSideSlideNavLeft clearfix shared_content" id="buttonu55153" data-content-guid="buttonu55153_content"><!-- container box -->
     ...
     <div class="Button menuSideSlideNavLeft clearfix" id="buttonu55196"><!-- container box -->
      <div class="menuSideSlideNavBG clearfix grpelem" id="u55197"><!-- column -->
       ...
       <div class="clearfix colelem shared_content" id="u55199" data-content-guid="u55199_content"><!-- group -->
        <div class="menuSideSlideNav-Btn grpelem" id="u55203" data-sizepolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>
     ...
     <div class="Button translateRight clearfix" id="buttonu55185"><!-- container box -->
      ...
      <div class="clearfix grpelem" id="u55188"><!-- group -->
       <div class="grpelem" id="u55189" data-sizepolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>
       <div class="grpelem" id="u55190" data-sizepolicy="fixed" data-pintopage="page_fluidx"><!-- simple frame --></div>
      </div>
     </div>
    </div>
    <div class="size_fixed grpelem shared_content" id="u40198" data-sizepolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u40198_content"><!-- custom html -->
     
        <?php echo do_shortcode('[ultimatemember_password]'); ?>
        
    </div>
    <div class="verticalspacer" data-offset-top="360" data-content-above-spacer="1058" data-content-below-spacer="490" data-sizepolicy="fixed" data-pintopage="page_fixedLeft"></div>
   </div>
  </div>
  <div class="breakpoint" id="bp_380" data-max-width="380"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- group -->
    <div class="clearfix grpelem temp_no_id" data-orig-id="pu55170"><!-- group -->
     <span class="placeholder" data-placeholder-for="u55170_content"><!-- placeholder node --></span>
     ...
     <span class="Button menuSideSlideNavLeft clearfix placeholder" data-placeholder-for="buttonu55153_content"><!-- placeholder node --></span>
    ...
    <span class="size_fixed grpelem placeholder" data-placeholder-for="u40198_content"><!-- placeholder node --></span>
    <div class="verticalspacer" data-offset-top="313" data-content-above-spacer="1068" data-content-below-spacer="537" data-sizepolicy="fixed" data-pintopage="page_fixedLeft"></div>
   </div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">if( window.jQuery ){ var $ = jQuery.noConflict(); } 
