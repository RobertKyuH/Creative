...
if(typeof Muse == "undefined") window.Muse = {}; window.Muse.assets = {"required":["museutils.js", "museconfig.js", "jquery.watch.js", "jquery.museresponsive.js", "require.js", "register.css"], "outOfDate":[]};
</script>
  ...
  <link rel="stylesheet" type="text/css" href="//robertcreativevibe.com/wp-content/themes/mxp_base_theme/mxp_theme/css/register.css?crc=109141470" id="pagesheet"/>
  <!-- IE-only CSS -->
  <!--[if lt IE 9]>
  <link rel="stylesheet" type="text/css" href="css/iefonts_register.css?crc=3824530138"/>
  <link rel="stylesheet" type="text/css" href="css/nomq_preview_master_a-master-light.css?crc=4204244850"/>
  <link rel="stylesheet" type="text/css" href="css/nomq_register.css?crc=500954086" id="nomq_pagesheet"/>
  <![endif]-->
  <!-- Other scripts -->
  <script type="text/javascript">if( window.jQuery ){ var $ = jQuery.noConflict(); } 
  ...
  <!--HTML Widget code-->
            ...
            #u40176 .um-field input, #u40176 .um-field textarea{
            ...
            #u40176 .um-col-alt input, #u40176 .um-col-alt a[href], #u40176 .um-col-alt-b a[href]{
                border-radius: 3px !important;
            ...
            #u40176 .um-col-alt input:hover, #u40176 .um-col-alt a[href]:hover, #u40176 .um-col-alt-b a[href]:hover{
                color: #FFFFFF;
            }

            #u40176 .um-field input::-webkit-input-placeholder { /* Chrome/Opera/Safari */
              color: #FFFFFF !important;
            }
            #u40176 .um-field input::-moz-placeholder { /* Firefox 19+ */
              color: #FFFFFF !important;
            }
            #u40176 .um-field input:-ms-input-placeholder { /* IE 10+ */
              color: #FFFFFF !important;
            }
            #u40176 .um-field input:-moz-placeholder { /* Firefox 18- */
              color: #FFFFFF !important;
            }
            ...
            <?php echo do_shortcode('[mxp_um_include_google_fonts fonts="  Lato:700|"]'); ?>
						...
						<style>
						#u40176 .um-col-alt input, #u40176 .um-col-alt a[href]{
							font-family: 'Lato';
						}
						</style>
 ...
 <body class=" <?php echo implode(" ", get_body_class()); ?>"><script>if( window.jQuery ){ var $ = jQuery.noConflict(); }</script>
  ...
  <div class="breakpoint active" id="bp_infinity" data-min-width="381"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox" id="page"><!-- group -->
    ...
    <div class="size_fixed grpelem shared_content" id="u40176" data-sizepolicy="fixed" data-pintopage="page_fluidx" data-content-guid="u40176_content"><!-- custom html -->
     
        <?php echo do_shortcode('[ultimatemember form_id= 27]'); ?>
        
    </div>
    <div class="verticalspacer" data-offset-top="717" data-content-above-spacer="1058" data-content-below-spacer="132" data-sizepolicy="fixed" data-pintopage="page_fixedLeft"></div>
   </div>
  </div>
  <div class="breakpoint" id="bp_380" data-max-width="380"><!-- responsive breakpoint node -->
   <div class="clearfix borderbox temp_no_id" data-orig-id="page"><!-- group -->
    ...
    <span class="size_fixed grpelem placeholder" data-placeholder-for="u40176_content"><!-- placeholder node --></span>
    <div class="verticalspacer" data-offset-top="638" data-content-above-spacer="1068" data-content-below-spacer="211" data-sizepolicy="fixed" data-pintopage="page_fixedLeft"></div>
   </div>
  </div>
  <!-- Other scripts -->
  <script type="text/javascript">if( window.jQuery ){ var $ = jQuery.noConflict(); } 
